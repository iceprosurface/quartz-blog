...
![|500](attachments/Pasted%20image%2020240929183901.png)

随后在任意目录新增一个资源：

![|400](attachments/Pasted%20image%2020240929183948.png)

 在搜索界面中搜索对应的 dialogue 即可，我们需要如下图所示中的 2 号资源。
 
![|500](attachments/Pasted%20image%2020240929184029.png)

随后我们通过双击新建的文件就可以在右侧开始编辑数据了：

![|500](attachments/Pasted%20image%2020240929184208.png)

## 新增 GUI 界面

新增 GUI 界面如下图所示，命名可以自行修改

![](attachments/Pasted%20image%2020240929184323.png)

界面如下图所示：
![](attachments/Pasted%20image%2020240929184415.png)
...
![|400](attachments/Pasted%20image%2020240929184631.png)
...
![|400](attachments/Pasted%20image%2020240929184735.png)

#### 图片大小不正确会随意变化

如果图片大小不正确，说明图片的拉伸模式设置的不对，可以设置为 fit width 以及 keep Aspect center， 并设置最小宽度： 
![|400](attachments/Pasted%20image%2020240929184924.png)

![|400](attachments/Pasted%20image%2020240929184945.png)
...
![|400](attachments/Pasted%20image%2020240929185756.png)
